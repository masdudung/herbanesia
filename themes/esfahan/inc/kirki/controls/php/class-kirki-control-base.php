	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'esfahan' ),
				'remove'               => esc_html__( 'Remove', 'esfahan' ),
				'default'              => esc_html__( 'Default', 'esfahan' ),
				'selectFile'           => esc_html__( 'Select File', 'esfahan' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'esfahan' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'esfahan' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'esfahan' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'esfahan' ),
			)
		);
