...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'esfahan' ),
				'change'       => esc_html__( 'Change image', 'esfahan' ),
				'default'      => esc_html__( 'Default', 'esfahan' ),
				'remove'       => esc_html__( 'Remove', 'esfahan' ),
				'placeholder'  => esc_html__( 'No image selected', 'esfahan' ),
				'frame_title'  => esc_html__( 'Select image', 'esfahan' ),
				'frame_button' => esc_html__( 'Choose image', 'esfahan' ),
			)
		);
	}
