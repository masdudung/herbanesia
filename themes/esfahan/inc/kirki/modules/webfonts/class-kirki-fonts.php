...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'esfahan' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'esfahan' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'esfahan' ),
			'200'       => esc_html__( 'Light 200', 'esfahan' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'esfahan' ),
			'300'       => esc_html__( 'Book 300', 'esfahan' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'esfahan' ),
			'400'       => esc_html__( 'Normal 400', 'esfahan' ),
			'regular'   => esc_html__( 'Normal 400', 'esfahan' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'esfahan' ),
			'500'       => esc_html__( 'Medium 500', 'esfahan' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'esfahan' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'esfahan' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'esfahan' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'esfahan' ),
			'700'       => esc_html__( 'Bold 700', 'esfahan' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'esfahan' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'esfahan' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'esfahan' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'esfahan' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'esfahan' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'esfahan' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'esfahan' ),
		);
	}
