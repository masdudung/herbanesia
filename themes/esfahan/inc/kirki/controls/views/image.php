...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'esfahan' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'esfahan' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'esfahan' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'esfahan' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'esfahan' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'esfahan' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'esfahan' ); ?>',
} );
#>
